...
"SELECT projects.title, (SUM(pledges.amount)-projects.funding_goal) AS money FROM projects JOIN pledges on projects.id = pledges.project_id GROUP BY projects.title HAVING money >=0;"
end
